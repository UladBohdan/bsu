...
//Translates an expression into a polish format
//Just + - * / and brackets ()
//Returns a string with spaces

string standart_to_polish (string a)
{
	const int M=9998999;
	string ans="";
	a+="+";
...
//Counts an expression in polish form
//Returns a double number - the answer

double count_polish (string a)
{
	stack <double> ans;
	while (a.length()>=1)
	{
...
int main()
{
    string s="1+(-8+7-3)*3+2/1";
    cout << standart_to_polish(s);
    return 0;
}
